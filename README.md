...
```bash
PICSEE_VERSION=0.2.22 PICSEE_BUILD_NUMBER=1 Scripts/build-app.sh
```
...
- DMG: `build/dmg/PicSee-0.2.22.dmg`

同样可以指定版本号：

```bash
PICSEE_VERSION=0.2.22 Scripts/build-dmg.sh
```
