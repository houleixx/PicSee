...
```bash
PICSEE_VERSION=0.2.8 PICSEE_BUILD_NUMBER=1 Scripts/build-app.sh
```
...
- DMG: `/Users/holly/code/Demo/PicSee/build/dmg/PicSee-0.2.8.dmg`

同样可以指定版本号：

```bash
PICSEE_VERSION=0.2.8 Scripts/build-dmg.sh
```
