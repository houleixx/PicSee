...
```bash
PICSEE_VERSION=0.2.52 PICSEE_BUILD_NUMBER=53 Scripts/build-app.sh
```
...
- DMG: `build/dmg/PicSee-0.2.52.dmg`

同样可以指定版本号：

```bash
PICSEE_VERSION=0.2.52 Scripts/build-dmg.sh
```
