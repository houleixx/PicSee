...
```bash
PICSEE_VERSION=0.2.9 PICSEE_BUILD_NUMBER=1 Scripts/build-app.sh
```
...
- DMG: `/Users/holly/code/Demo/PicSee/build/dmg/PicSee-0.2.9.dmg`

同样可以指定版本号：

```bash
PICSEE_VERSION=0.2.9 Scripts/build-dmg.sh
```
